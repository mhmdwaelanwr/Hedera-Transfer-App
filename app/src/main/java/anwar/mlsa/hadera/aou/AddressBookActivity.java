...
public class AddressBookActivity extends AppCompatActivity implements AddContactDialogFragment.AddContactDialogListener {
    ...
    private void showAddContactDialog() {
        ...
        dialogFragment.show(getSupportFragmentManager(), "AddContactDialogFragment");
    }
